...
//       {/* Sidebar */}
//       <div
//         className={`z-10 md:fixed flex flex-col justify-between overflow-x-hidden bg-gray-100 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform transition duration-200 ease-in-out ${
//           isActive ? "-translate-x-full" : "translate-x-0"
//         } md:translate-x-0 md:flex md:flex-col md:space-y-6 md:px-4`}
//       >
//         <div>
//           {/* Branding & Profile Info */}
//           <div>
