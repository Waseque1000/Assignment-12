...
//       {/* Sidebar */}
//       <div
//         className={`z-10 md:fixed flex flex-col justify-between bg-gray-100 w-64 h-screen space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform transition-all duration-200 ease-in-out ${
//           isActive ? "-translate-x-full" : "translate-x-0"
//         } md:translate-x-0 md:flex md:space-y-6 md:px-4`}
//       >
//         <div>
